    ...
    <section id={id} className="py-8 sm:py-12 bg-white scroll-mt-20">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 overflow-hidden rounded-lg border border-border bg-card">
          <div
            className={`relative min-h-[200px] lg:min-h-0 lg:aspect-auto aspect-video bg-muted flex items-center justify-center ${reverse ? "lg:order-2" : ""}`}
          >
            {imageSrc ? (
              <Image
                src={imageSrc}
          ...
          <div
            className={`flex flex-col justify-center p-6 sm:p-8 text-left bg-card ${reverse ? "lg:order-1" : ""}`}
          >
            ...
            <Button
              asChild
              size="lg"
              className="font-bold uppercase text-lg sm:text-xl py-6 px-8 sm:py-7 sm:px-10"
            >
